...
//using Hilal.DataViewModels.Enum;
...
//        public CustomAuthorizeAttribute(bool isLoginRequired)
//        {
...
//                {
//                    context.HttpContext.Response.StatusCode = 401;
//                    context.Result = new JsonResult(new Response<bool> { isError = true, messages = Error.AccoutNotVerified, data = false });
//                    return;
//                }
//            }
//            else
//            {
//                context.RouteData.Values.Add("userId", "");
